...
export class PersonForm extends Component 
{
    ...
    render()
    {
        return <div className='personFormContainer'>
            <div className='personFormBg' onClick={this.props.hideForm}></div>
            <Form className='personForm' onSubmit={this.props.registerPerson}>
                <FormGroup row>
